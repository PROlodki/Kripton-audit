"""
Django settings for kripton project.
...
SECRET_KEY = 'django-insecure-#6t!$ren87@2l*9ff&xhzdxt#jlgh-pec#0fkro7z_t&fn0#x)'
...
USE_CLICKHOUSE = False   #отключение кликхауса, в скоре надо будет удалить полностью
>>>>>>> Stashed changes
